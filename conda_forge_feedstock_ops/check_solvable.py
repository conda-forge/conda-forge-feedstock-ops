...
def _is_recipe_solvable_on_platform(
    ...
    for m, _, _ in metas:
        ...
        if build_req:
            ...
            print_debug(f"build run exports::\n\n{pprint.pformat(build_rx)}\n")
        ...
        if host_req:
            ...
            print_debug(f"host run exports::\n\n{pprint.pformat(host_rx)}\n")
        ...
        if run_req:
            print_debug(f"run reqs before pins:\n\n{pprint.pformat(run_req)}\n")
            ...
            print_debug(f"run reqs after pins:\n\n{pprint.pformat(run_req)}\n")
