...
try:
    from conda_forge_feedstock_ops.mamba_solver import (
        MambaSolver,
...
from conda_forge_feedstock_ops.rattler_solver import (
    RattlerSolver,
    rattler_solver_factory,
)
from conda_forge_feedstock_ops.utils import apply_pins, suppress_output
...
""",
    ...
    print("build req:", pprint.pformat(build_req))
    print("build rex:", pprint.pformat(rx))
    ...
    print("host req:", pprint.pformat(host_req))
    print("host rex:", pprint.pformat(rx))
    run_req = list(set(run_req) | rx["weak"])
    run_req = apply_pins(run_req, host_req, build_req, outnames, m)
    print("run req:", pprint.pformat(run_req))
